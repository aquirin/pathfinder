...
extern double **pfnet;	//si pfnet[i][j]=TRUE hay un enlace entre los nodos i y j
extern int num_nodos;	//numero de nodos de la matriz
extern int num_edges;	// number of edges in the matrix
extern double **pesos_originales;
extern SEDGE **vedges;
...
extern double ** Matriz_dinamica_float(int nfil, int ncol);	//reserva memoria para una matriz de flotantes
extern void Libera_matriz_dinamica_float (double **matriz, int nfils);	//libera memoria de una matriz de flotantes
